                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span>
                            <h6 class="w3-center item-title w3-round w3-animate-zoom" style="font-size: 50px; color: black; padding: 10px; font-weight: bold;">
                                <i class="w3-padding w3-animate-fading"><b>DIVORCE EVENT RECORDS</b></i>
                            </h6>
                       </span>                       
                      </div>
                </div>
                                ...
                                <div class="dash-item fist-dash-item">
                                 ...
                                 <!--====================Searched view =========================================-->
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM divorceevent WHERE dveventnum='$divorceNumber' ";
                                         ...
                                         $sql="SELECT * FROM divorceevent WHERE dveventnum='$divorceNumber' order by id desc LIMIT $thisPageResult,$resultPerPage ";
                                  ...
                                  <?php
                                      if (!isset($_POST['searchdivorce'])) {
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM divorceevent WHERE 1 ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM divorceevent WHERE 1 order by id desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
