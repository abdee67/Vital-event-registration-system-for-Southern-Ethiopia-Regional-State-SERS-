                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue; ">
                    ...
                    <span>
                            <h6 class="w3-center item-title w3-round w3-animate-zoom" style="font-size: 50px; color: black; padding: 10px; font-weight: bold;">
                                <i class="w3-padding w3-animate-fading"><b>ADOPTION EVENT RECORDS</b></i>
                            </h6>
                       </span>                      
                      </div>
                </div>
                            ...
                            <div class="col-lg-12 clear-padding-xs">
                                <div class="dash-item fist-dash-item">
                                  ...
                                  <?php
                                      ...
                                      <?php 
                                        ...
                                        $resultPerPage=10;
                                        $query="SELECT *FROM adoptevent where adoptnum='$adoptNumber'";
                                       ...
                                       $sql="SELECT * FROM adoptevent WHERE adoptnum='$adoptNumber' order by adoptnum LIMIT $thisPageResult,$resultPerPage ";
                                      ...
                                      <?php
                                         while($row=mysqli_fetch_array($run)){
                                             ...
                                             <tr>
                                                ...
                                                <td><a href="report-adoption-individual.php?AdoptID=<?php echo $row['adoptnum']; ?>"><i class="fa fa-bullhorn"></i></a></td>
                                            </tr>
                                            <?php
                                             ?>       
                                            </a><?php
                                ...
                                for($page=1;$page<$numberOfPages;$page++)
                                  ...
                                  <?php
                                     ...
                                     <?php 
                                        $resultPerPage=10;
                                        $query="SELECT *FROM adoptevent where 1 ";
                                        $run=mysqli_query($con,$query);
                                        $num=mysqli_num_rows($run);
                                        $numberOfPages=ceil($num/$resultPerPage);
                                       ...
                                       $thisPageResult=($page-1)*$resultPerPage;
                                       $sql="SELECT * FROM adoptevent WHERE 1 order by adoptnum LIMIT $thisPageResult,$resultPerPage ";
                                      if($run=mysqli_query($con,$sql)){
                                           ?>
                                        <table class="w3-table-all">
                                           <style type="text/css">
