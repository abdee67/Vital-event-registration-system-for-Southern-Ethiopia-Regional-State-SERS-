                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span>
                            <h6 class="w3-center item-title w3-round w3-animate-zoom" style="font-size: 50px; color: black; padding: 10px; font-weight: bold;">
                                <i class="w3-padding w3-animate-fading"><b>DEATH EVENT RECORDS</b></i>
                            </h6>
                       </span>                       
                      </div>
                </div>
                                ...
                                <div class="dash-item fist-dash-item">
                                  ...
                                  <?php
                                      if (isset($_POST['searchdeath'])) {
                                        //echo "Begin Search";
                                        $deathNumber=$_POST['deathnum'];
                                        ?>
                                        <!--=============<h1>Searched</h1>============-->
                                     <?php 
                                          if (empty($deathNumber)) {
                                            echo "<p style='color:red;text-align:center;'>Empty Death Number</p>";
                                          }
                                          $resultPerPage=10;
                                          $query="SELECT *FROM deathevent where eventnumber='$deathNumber' ";
                                         ...
                                         $sql="SELECT * FROM deathevent WHERE eventnumber='$deathNumber'  order by eventnumber LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                              $check=mysqli_num_rows($run);
                                              if (!empty($deathNumber) && $check==0) {
                                          ...
                                          <table class="w3-table-all">
                                           ...
                                           <tr>
                                              ...
                                              <th class="small">Sex <BR>ጾታ</th>
                                              <th class="small">Nationality</th>
                                              <th class="small">Religion</th>
                                              <th class="small">Job <BR>ሥራ</th>
                                              <th class="small">Death Date</th>
                                              <th class="small w3-center" >Report</th>
                                         </tr>
                                        <?php
                                           while($row=mysqli_fetch_array($run)){
                                               ...
                                               <tr>
                                                  ...
                                                  <td><a href="report-death-individual.php?DeathRep=<?php echo $row['eventnumber']; ?>"><i class="fa fa-bullhorn"></i></a></td>
                                              </tr>
                                              <?php
                                               ?>       
                                              </a><?php
                                  ...
                                  for($page=1;$page<$numberOfPages;$page++)
                                      {
                                      echo " <a href=\"view-death.php?page=".$page." \" class=\"w3-button btn btn-link\">".$page."</a> ";
                                      }
                                       ?></h3>  
                                  ...
                                  <?php
                                      ...
                                      <!--===================  <h1>Normal</h1>================-->
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM deathevent where 1";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM deathevent WHERE 1 order by eventnumber LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
