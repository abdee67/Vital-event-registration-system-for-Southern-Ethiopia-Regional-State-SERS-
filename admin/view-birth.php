                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span>
                            <h6 class="w3-center item-title w3-round w3-animate-zoom" style="font-size: 50px; color: black; padding: 10px; font-weight: bold;">
                                <i class="w3-padding w3-animate-fading"><b>BIRTH EVENT RECORDS</b></i>
                            </h6>
                       </span>                       
                      </div>
                </div>
                                      ...
                                      if (isset($_POST['searchbirth'])) {
                                       ...
                                       <!--======================== <h1>Searched</h1>========================-->
                                        <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM birthevent where eventnumber='$birthNumber' ";
                                         ...
                                         $sql="SELECT * FROM birthevent WHERE eventnumber='$birthNumber' order by eventnumber desc LIMIT $thisPageResult,$resultPerPage ";
                                  ...
                                  <?php
                                      if (!isset($_POST['searchbirth'])) {
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM birthevent where 1 ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM birthevent WHERE 1 order by eventnumber desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
