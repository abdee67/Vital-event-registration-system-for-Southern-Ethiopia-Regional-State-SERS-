                                ...
                                <div class="dash-item fist-dash-item">
                                  ...
                                  <?php
                                     ...
                                     <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM deathevent where wcode='$WCode' AND zcode='$ZCode' AND eventnumber='$deathNum'";
                                         ...
                                         $sql="SELECT * FROM deathevent WHERE wcode='$WCode' AND zcode='$ZCode' AND eventnumber='$deathNum' order by eventnumber LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                              $check=mysqli_num_rows($run);
                                              if (!empty($deathNum) && $check==0) {
                                        ...
                                        <?php
                                           while($row=mysqli_fetch_array($run)){
                                               ...
                                               <tr>
                                                  ...
                                                  <td><a href="death-report-individual.php?DeathId=<?php echo $row['eventnumber']; ?>"><i class="fa fa-bullhorn"></i></a></td>
                                              </tr>
                                              <?php
                                               ?>       
                                              </a><?php
                                  ...
                                  <?php
                                      if (!isset($_POST['searchdeath'])) {
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM deathevent where wcode='$WCode' AND zcode='$ZCode' ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM deathevent WHERE wcode='$WCode' AND zcode='$ZCode' order by eventnumber LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
