                                ...
                                <div class="dash-item fist-dash-item">
                                  <div class="report" style="border:thick solid black;" >                            
                                    <?php
                                      ...
                                      <h4 class="w3-text-black" style="font-weight: bold;font:serif;text-align: center;">Divorce Report</h4>
                                      <br>
                                    <form action="" method="POST"> 
                                    	<?php 
                                    		 $LoggedInName=$_SESSION['LoginUsername'];
                                             if(isset($_GET['DivorceID'])){

                                                   $divorceid=$_GET['DivorceID'];
                                                    
                                                    $selectreport="SELECT * FROM report WHERE eventnumber ='$divorceid' AND reportby='$LoggedInName' AND role='Wver' AND type='Divorce' ORDER BY id DESC";
                                            ...
                                            <div class="col-md-11" style="color: black;width: 897px;border-top: none;">
                                              <?php
                                                  if(isset($_GET['DivorceID'])){
                                                    ...
                                                    $divorceid=$_GET['DivorceID'];
                                                    $selectRep="SELECT * FROM report WHERE eventnumber='$divorceid'AND reportby='$LoggedInName' AND role='Wver'AND type='Divorce' ORDER BY id DESC";
                                                    ...
                                                    if ($Res) {
                                                        ...
                                                        echo "<br><br><br><br><br><br><br><br><p style='margin-right:150px;'>$reDet</p>";
                                                   }
                                                 }
                                               ?>
                                           </div>
