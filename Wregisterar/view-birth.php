                                ...
                                <div class="dash-item fist-dash-item">
                                  ...
                                  <?php
                                      ...
                                      <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM birthevent where woreda='$WCode' AND zone='$ZCode' AND eventnumber='$birthNum'  ";
                                         ...
                                         $sql="SELECT * FROM birthevent WHERE woreda='$WCode' AND eventnumber='$birthNum' order by eventnumber desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                              $check=mysqli_num_rows($run);
                                              if (!empty($birthNum) && $check==0) {
                                        ...
                                        <?php
                                           while($row=mysqli_fetch_array($run)){
                                               ...
                                               <tr>
                                                  ...
                                                  <td><a href="birth-report-individual.php?BirthDetId=<?php echo $row['eventnumber']; ?>"><i class="fa fa-bullhorn"></i></a></td>
                                  ...
                                  <?php
                                      if (!isset($_POST['searchbirth'])) {
                                       ...
                                       <?php 
                                          $resultPerPage=10;
                                          $query="SELECT *FROM birthevent where woreda='$WCode' AND zone='$ZCode' ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM birthevent WHERE woreda='$WCode' AND zone='$ZCode' order by eventnumber desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
