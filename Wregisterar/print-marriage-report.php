   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo "<b>GENERATE REPORT FOR MARRIAGE</b>";?> </h2></span>
                    </div>
                </div>
               ...
               <script type="text/javascript">
                ...
                <form>
                   <input type="button" name="" onclick="printDiv('print-content')" value="Print Report" style="float: left; margin-bottom: -10px; margin-left: 15px;" class="w3-text-white ww3-blue">
                </form>
                                    	...
                                    	<?php 
                                             ...
                                             if(isset($_GET['MarrId'])){
                                                   ...
                                                   $marrgid=$_GET['MarrId'];
                                                    ...
                                                    $selectreport="SELECT * FROM report WHERE eventnumber ='$marrgid'AND reportby='$LoggedInName' AND role='Wver' AND type='Marriage' ORDER BY id DESC";
                                            ...
                                            <div class="col-md-11" style="color: black;width: 897px;border-top: none;">
                                              <?php
                                                  if(isset($_GET['MarrId'])){
                                                    ...
                                                    $marrgid=$_GET['MarrId'];
                                                    $selectRep="SELECT * FROM report WHERE eventnumber='$marrgid'AND reportby='$LoggedInName' AND role='Wver'AND type='Marriage' ORDER BY id DESC";
