   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo "<b>GENERATE REPORT FOR DEATH</b>";?> </h2></span>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 clear-padding-xs">
                                <div class="dash-item fist-dash-item">
                                  <div class="report" style="border:thick solid black;padding-right: 50px;" >
                                    <?php
                                        $today=date("M d,Y");
                                      ?>
                                      ...
                                      <h4 class="w3-text-black" style="font-weight: bold;font:serif;text-align: center;">Death Report</h4>
                                      <br>
                                    ...
                                    <form action="" method="POST"> 
                                        <?php 
                                             if(isset($_GET['DeathID'])){
                                                   ...
                                                   $deathid=$_GET['DeathID'];
                                                    ...
                                                    $selectreport="SELECT * FROM report WHERE eventnumber ='$deathid' ORDER BY id DESC";
                                      ...
                                      <label style="color: black; font-weight: bold; margin-left: 100px;">
                                         For:&nbsp;&nbsp;</label>
                                         <input type="text" name="forwhom" value="<?php echo $who; ?>" style="border-top:none;border-bottom: 1px solid black;border-left: none; color: black;width: 400px;">
                                         <br> <br> <br>
                                         <?php
                                         ...
                                         ?>
                                      <label style="color: black; font-weight: bold; margin-left: 100px;">Title:</label>

                                       <input type="text" name="reportTitle" value="<?php echo $Title; ?>" style="border-top:none;border-bottom: 1px solid black;border-left: none; color: black;width: 400px;">
                                         <br><br>
                                         <label style="color: black; font-weight: black; margin-left: 100px;font-size: 20px;"><u>Individual Information</u></label>
                                         <br>
                                         <div class="row" style="margin-left: 70px;" style=" height: 100px;">
                                           <div class="col-md-11" style="height: 400px; color: black">
                                            ...
                                            <div class="col-md-11" style="color: black;">
                                              <?php
                                                  if(isset($_GET['DeathID'])){
                                                    ...
                                                    $deathid=$_GET['DeathID'];
                                                    $selectRep="SELECT * FROM report WHERE eventnumber='$deathid' ORDER BY id DESC";
                                                    ...
                                                    if ($Res) {
                                                        ...
                                                        echo "<p style='margin-right:150px;'>$reDet</p>";
                                                   }
                                                 }
                                               ?>
                                           </div>
