                    ...
                    <div style="margin-top: 5px;">
                        <span>
                            <h6 class="w3-center item-title w3-round w3-animate-zoom" style="font-size: 50px; color: black; padding: 10px; font-weight: bold;">
                                <i class="w3-padding w3-animate-fading"><b>USER PAGE</b></i>
                            </h6>
                        </span>                     
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 clear-padding-xs">
                                <div class="dash-item fist-dash-item">
                                    <h3 class="item-title w3-text-green"><i class="fa fa-user"></i><?php echo $_SESSION['LoginUsername']; ?>'s PROFILE</h3>
                                    ...
                                    <div class="inner-item dash-searc-form">
                                        <?php
                                            ...
                                            $adminquery=mysqli_query($con,$selectuser);
                                            $admindet=mysqli_fetch_array($adminquery);
                                            $name=$admindet['name'];
                                        ...
                                        <div class="col-md-4 col-lg-6">
                                            ...
                                            <h4><b>Full Name</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $admindet['FullName'] ;?></h4>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-lg-6">
                                            ...
                                            <h4><b>Assigned Woreda</b>:&nbsp;<?php echo $woredaname ;?></h4>
                                        </div>
