   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo "<b>GENERATE REPORT FOR BIRTH</b>";?> </h2></span>
                    </div>
                </div>
                ...
                <form>
                   <input type="button" name="" onclick="printDiv('print-content')" value="Print Report" style="float: left; margin-bottom: -10px; margin-left: 15px;" class="w3-text-white w3-blue">
                </form>
                                ...
                                <div class="dash-item fist-dash-item">
                                  <div class="report" style="border:thick solid black;" >
                                    <?php
                                      ...
                                      <h4 class="w3-text-black" style="font-weight: bold;font:serif;text-align: center;">Birth Report</h4>
                                      <br>
                                       ...
                                       <?php 
                                             ...
                                             if(isset($_GET['ID'])){
                                                   ...
                                                   $birthid=$_GET['ID'];
                                                    ...
                                                    $selectreport="SELECT * FROM report WHERE eventnumber ='$birthid' AND reportby='$LoggedInName' AND role='Wver' AND type='Birth' ORDER BY id DESC";
                                        ...
                                        ?>
                                      <label style="color: black; font-weight: black; margin-left: 100px; font-weight: bold;">
                                         For:&nbsp;&nbsp;</label>
                                         <input type="text" name="forwhom" value="<?php echo $who;?>" style="border-top:none;border-right: none; border-bottom: 1px solid black;border-left: none; color: black;width: 450px;" readonly="">
                                         <br> <br> <br>
                                      <label style="color: black; font-weight: black; margin-left: 100px;font-weight: bold;">Title:</label>

                                       <input type="text" value="<?php echo $Title;?>" name="reportTitle" style="border-top:none;border-right: none; border-bottom: 1px solid black;border-left: none; color: black;width: 450px;" readonly="">
                                         <br><br>
                                         <label style="color: black; font-weight: black; margin-left: 80px;font-size: 20px;"><b><u>Individual Information</u>:</b></label>
                                         <br>
                                              ...
                                              <?php
                                               $LoggedInName=$_SESSION['LoginUsername'];
                                                if(isset($_GET['ID'])){
                                                   ...
                                                   $selectRep="SELECT * FROM report WHERE eventnumber ='$birthid' AND reportby='$LoggedInName' AND role='Wver' AND type='Birth' ORDER BY id DESC";
                                                   $Res=mysqli_query($con,$selectRep);
                                                   if ($Res) {
                                                    $rePList=mysqli_fetch_assoc($Res);
                                                   echo  $reDet=$rePList['detail'];
                                                   }
                                                 }
                                               ?>
                                           </div>
                                        ...
                                        <div class="col-md-12" style="color: black;margin-left: 50px;padding-right:100px; ">
                                            <?php
                                               ...
                                               echo "<b><p style='margin-left:450px;'><i>Woreda Vital Event Registrar </i></p><b>";
                                            ?>
                                          </div>
