       ...
       <!--==============================ANNUAL REPORT BEGIS HERE==========================-->
        <div class="right_col" role="main">
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo "<b>ANNUAL REPORT</b>";?> </h2></span>
                    </div>
                </div>
                                    ...
                                    <div class="report">
                                        ...
                                        <?php
                                            if (isset($_POST['find'])) {
                                                ...
                                                echo "<br>";
                                                $year= $_SESSION['year'];
                                                if (($type=='Birth Event') && ($type!='Choose Event Type here') && ($year!='Choose Year here')  ){
                                                   // echo "Birth Event";
                                                    echo "<script> window.location.replace('birth-annual-report.php');</script>";


                                                }
                                                else if (($type=='Death Event') && ($type!='Choose Event Type here') && ($year!='Choose Year here')){
                                                    //echo "Death Event";
                                                     echo "<script> window.location.replace('death-annual-report.php');</script>";
                                                }
                                                elseif (($type=='Marriage Event') && ($type!='Choose Event Type here') && ($year!='Choose Year here')){
                                                   // echo "Marriage Event";
                                                    echo "<script> window.location.replace('marriage-annual-report.php');</script>";
                                                }
                                                elseif (($type=='Divorce Event') && ($type!='Choose Event Type here') && ($year!='Choose Year here')){
                                                    //echo "Divorce Event";
                                                     echo "<script> window.location.replace('divoce-anual-report.php');</script>";
                                                }
                                                elseif (($type=='Adoption Event') && ($type!='Choose Event Type here') && ($year!='Choose Year here')){
                                                    //echo "Adoption Event";
                                                     echo "<script> window.location.replace('adoption-annual-report.php');</script>";
                                                }
