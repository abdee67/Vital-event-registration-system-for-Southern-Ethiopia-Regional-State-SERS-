                               ...
                               <div class="report" style="border:thick solid black;">                                  
                                    <?php
                                      ...
                                      <div style="border-bottom: 3px solid gray;">
                                          <h3 class="w3-text-black " style="font:sans-serif;font-weight: bolder;margin-top: 20px;text-align: center;">SERS<br> <br> Vital Events Registraion</h3>
                                      </div>
                                      <br>
                                      ...
                                      <div class="birhteport" style="margin-left: 10px; align-items: center;color: black;">
                                      	...
                                      	<?php
                                      		$selectDivorce="SELECT * FROM divorceevent WHERE kcode='$KCode' AND wcode='$WCode' AND zcode='$ZCode' AND regyear='$year' AND regmonth='$month'";
