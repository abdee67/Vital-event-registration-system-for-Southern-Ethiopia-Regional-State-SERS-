   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue; ">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo "<b>ADOPTION ANNUAL REPORT</b>";?> </h2></span>
                    </div>
                </div>
                <!--let begin here-->
                               ...
                               <div class="report" style="border:thick solid black;">                                  
                                    <?php
                                      ...
                                      <div class="birhteport" style="margin-left: 10px; align-items: center;">
                                      	...
                                      	<?php
                                      		$selectAdoption="SELECT * FROM adoptevent WHERE kcode='$KCode' AND wcode='$WCode' AND zcode='$ZCode' AND regyear='$year'";
