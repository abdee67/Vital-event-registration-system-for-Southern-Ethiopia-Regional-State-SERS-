                               ...
                               <div class="report" style="border:thick solid black;">                                  
                                    <?php
                                      ...
                                      <div class="birhteport" style="margin-left: 10px; align-items: center;color: black;">
                                      	...
                                      	<?php
                                      		$selectMarriage="SELECT * FROM marriagevent WHERE kcode='$KCode' AND wcode='$WCode' AND zcode='$ZCode' AND regyear='$year' AND regmonth='$month'";
