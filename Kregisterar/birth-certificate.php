                    ...
                    <div class="container-fluid" style="background-color: white;" id="print-content">
                        ...
                        <form style="border:thick solid green;">
                           ...
                           <?php
                                ...
                                if (!isset($_GET['Cert'])) {
                                  echo "<script>";
                                    echo "window.location='birth-view.php'";
                                  echo "</script>"; 
                                }
                               $_SESSION['birthnumber']=$_GET['Cert'] ;
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-10">
                                 <div class="" style="margin-top: 7px; text-align: center;">
                                   ...
                                   <br>
                                   <h5 class="w3-text-black" style="font-family: sans-serif; text-align: center;"><b>BIRTH CERTIFICATE</b></h5>
                               </div>
                           </div>
                           <br><br>
                           <table style="color: black;">
                               <tr>
                                   ...
                                   <td width="50px" ></td>
                                   <td width="200px"  style="padding: 5px;"><h5> <b>Weight:</b></h5></td><td width="200px"><?php echo $Weight; ?></td>
                               </tr>
                               <tr>
                                   <td width="270px"><h5><b> &nbsp;&nbsp;&nbsp;&nbsp;First Name:<b/><h5></td><td width="200px"><?php echo $FirstName; ?></td>
                                   <td width="50px" ></td>
                                   <td width="200px"  style="padding: 5px;"><h5> <b>Blood Type:</b></h5></td><td width="200px"><?php echo $Blood; ?></td>
                               </tr>
                               <tr>
                               ...
                               <tr>
                                ...
                                <tr>
                                   ...
                                   <td width="50px" ></td>
                                   <td width="200px"  style="padding: 5px;"><h5> <b>Mother Full Name:</b></h5></td><td width="200px"><?php echo $MoName; ?></td>
                               </tr>
                                <tr>
                                   <td width="270px"><h5><b> &nbsp;&nbsp;&nbsp;&nbsp;Nationality:<b/><h5></td><td width="200px"><?php echo $Nationality; ?></td>
                                   <td width="50px" ></td>
                                   <td width="200px"  style="padding: 5px;"><h5> <b>Registration Type:</b></h5></td><td width="200px"><?php echo $Regtype; ?></td>
                               </tr>
