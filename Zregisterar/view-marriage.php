                                ...
                                <div class="dash-item fist-dash-item">
                                  ...
                                  <?php
                                      ...
                                      //  echo "Begin Search";
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM marriagevent WHERE zcode='$ZCode' AND marriagenum='$marrNumber' ";
                                         ...
                                         $sql="SELECT * FROM marriagevent WHERE zcode='$ZCode' AND marriagenum='$marrNumber' order by id desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                              $check=mysqli_num_rows($run);
                                              if (!empty($marrNumber) && $check==0) {
                                  ...
                                  <?php
                                      if (!isset($_POST['searchmarr'])) {
                                       ...
                                       <?php 
                                          $resultPerPage=10;
                                          $query="SELECT *FROM marriagevent WHERE zcode='$ZCode' ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM marriagevent WHERE zcode='$ZCode' order by id desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
