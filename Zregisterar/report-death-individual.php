                                         ...
                                         <div class="row" style="margin-left: 70px;" style="border: solid 2px; height: 100px;">
                                           <div class="col-md-11" style="border: solid 2px;height: 500px; color: black">
                                              ...
                                              <?php
                                                ...
                                                if(isset($_GET['DeathRep'])){

                                                   $deathid=$_GET['DeathRep'];
                                                ...
                                                <?php
                                                  ...
                                                  if(isset($_POST['savereport'])) {
                                                    ...
                                                    if (!empty($for) && !empty($title) && !empty($reportdet)) {
                                                       $insertRe="INSERT INTO report(eventnumber,forwhom,title,detail,zone,woreda,kebele,role,reportby,type) VALUES ('$deathid','$for','$title','$reportdet','$zone','$woreda','$kebele','$role','$LoggedInName','Death')";
