   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo " "." ".'<b>'." GENERATE REPORT FOR MARRIAGE EVENT".'</b>';?> </h2></span>
                    </div>
                </div>
                <!--let begin here-->
                                ...
                                <div class="dash-item fist-dash-item">
                                  <div class="report" style="border:thick solid black;" >
                                    ...
                                    <?php
                                      ...
                                      <h4 class="w3-center w3-text-black" style="font-weight: bold;font:serif;">Marriage Report</h4>
                                      <br>
                                    <form action="" method="POST"> 
                                      ...
                                      <label style="color: black; font-weight: black; margin-left: 100px;">Title:</label>
                                       ...
                                       <input type="text" name="reportTitle" style="border-top:none;border-bottom: 1px solid black;border-left: none; color: black;width: 600px;">
                                         ...
                                         <div class="row" style="margin-left: 70px;" style="border: solid 2px; height: 100px;">
                                           <div class="col-md-11" style="border: solid 2px;height: 555px; color: black">
                                              ...
                                              <?php
                                                ...
                                                if(isset($_GET['MarrRep'])){

                                                   $marrgId=$_GET['MarrRep'];
                                                ...
                                                <?php
                                                  if(isset($_POST['savereport'])) {
                                                    ...
                                                    if (!empty($for) && !empty($title) && !empty($reportdet)) {
                                                       $insertRe="INSERT INTO report(eventnumber,forwhom,title,detail,zone,woreda,kebele,role,reportby,type) VALUES ('$marriagenum','$for','$title','$reportdet','$zone','$woreda','$kebele','$role','$LoggedInName','Marriage')";
                                         ...
                                         <br>
                                         <input type="submit" name="savereport" value="Save" style="margin-left: 100px;width: 100px;background-color: blue; color: black;">
                                         <a href="print-marriage-report.php?MarrId=<?php echo $marriagenum;?>" style="margin-left: 30px; color: blue;font-weight: bold;">Open</a>
                                    </form>
