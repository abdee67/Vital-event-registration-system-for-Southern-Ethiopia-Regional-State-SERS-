                                ...
                                <div class="dash-item fist-dash-item">
                                  ...
                                  <?php
                                      if (isset($_POST['searchbirth'])) {
                                        //echo "Begin Search";
                                        $birthNumber=$_POST['birthnum'];
                                        ?>
                                       <!--===== <h1>Searched</h1>====-->
                                      <?php 
                                          if (empty($birthNumber)) {
                                             echo "<p style='color:red;text-align:center'>Empty Birth Number</p>";
                                          }
                                          $resultPerPage=10;
                                          $query="SELECT *FROM birthevent where zone='$ZCode' AND eventnumber='$birthNumber' ";
                                         ...
                                         $sql="SELECT * FROM birthevent WHERE zone='$ZCode' AND eventnumber='$birthNumber' order by eventnumber desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                              $check=mysqli_num_rows($run);
                                              if (!empty($birthNumber) && $check==0) {
                                                echo "<p style='color:red;text-align:center'>Record Not Exit</p>";
                                              }
                                             ?>
                                        ...
                                        <?php
                                           while($row=mysqli_fetch_array($run)){
                                               ...
                                               <tr>
                                                  ...
                                                  <td><a href="report-birth-individual.php?BirthRep=<?php echo $row['eventnumber']; ?>"><i class="fa fa-bullhorn"></i></a></td>
                                  ...
                                  for($page=1;$page<$numberOfPages;$page++)
                                      {
                                      echo " <a href=\"view-birth.php?page=".$page." \" class=\"w3-button btn btn-link\">".$page."</a> ";
                                      }
                                       ?></h3> 
                                  ...
                                  <?php
                                      if (!isset($_POST['searchbirth'])) {
                                       ...
                                       <?php 
                                          $resultPerPage=10;
                                          $query="SELECT *FROM birthevent where zone='$ZCode' ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM birthevent WHERE zone='$ZCode' order by eventnumber desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table  class="w3-table-all">
                                            <style type="text/css">
