   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo " "." ".'<b>'." PRINT REPORT FOR BIRTH".'</b>';?> </h2></span>
                    </div>
                </div>
                                  ...
                                  <div class="report" style="border:thick solid black;" >
                                    ...
                                    <form action="" method="POST"> 
                                       <?php 
                                             ...
                                             $selctuser="SELECT * FROM memberuser WHERE name='$LoggedInName'";
                                             $userResult=mysqli_query($con,$selctuser);
                                             ...
                                             if(isset($_GET['ID'])){
                                                   ...
                                                   $birthid=$_GET['ID'];
                                                    ...
                                                    $selectreport="SELECT * FROM report WHERE eventnumber ='$birthid' AND reportby='$LoggedInName' AND role='$role' AND type='Birth' ORDER BY id DESC";
                                              ...
                                              <?php
                                               ...
                                               $role=$userList['role'];
                                                if(isset($_GET['ID'])){
                                                   ...
                                                   $selectRep="SELECT * FROM report WHERE eventnumber ='$birthid' AND reportby='$LoggedInName' AND role='$role' AND type='Birth' ORDER BY id DESC";
