                                  ...
                                  <?php
                                      if (isset($_POST['searchdeath'])) {
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM deathevent where zcode='$ZCode' AND eventnumber='$deatNumber' ";
                                         ...
                                         $sql="SELECT * FROM deathevent WHERE zcode='$ZCode' AND eventnumber='$deatNumber' order by eventnumber LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                              $check=mysqli_num_rows($run);
                                              if (!empty($deatNumber) && $check==0) {
                                  ...
                                  <?php
                                      if (!isset($_POST['searchdeath'])) {
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM deathevent where zcode='$ZCode' ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM deathevent WHERE zcode='$ZCode' order by eventnumber LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
