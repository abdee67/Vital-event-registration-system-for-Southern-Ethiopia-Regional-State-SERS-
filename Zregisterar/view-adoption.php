                                ...
                                <div class="dash-item fist-dash-item">
                                  ...
                                  <?php
                                     ...
                                     <?php 
                                        ...
                                        $resultPerPage=10;
                                        $query="SELECT *FROM adoptevent where zcode='$ZCode' AND adoptnum='$adoptNumber' ";
                                       ...
                                       $sql="SELECT * FROM adoptevent WHERE zcode='$ZCode' AND adoptnum='$adoptNumber' order by adoptnum LIMIT $thisPageResult,$resultPerPage ";
                                ...
                                for($page=1;$page<$numberOfPages;$page++)
                                  ...
                                  <?php
                                     ...
                                     <?php 
                                        ...
                                        $resultPerPage=10;
                                        $query="SELECT *FROM adoptevent where zcode='$ZCode' ";
                                        $run=mysqli_query($con,$query);
                                        $num=mysqli_num_rows($run);
                                        $numberOfPages=ceil($num/$resultPerPage);
                                       ...
                                       $thisPageResult=($page-1)*$resultPerPage;
                                       $sql="SELECT * FROM adoptevent WHERE zcode='$ZCode' order by adoptnum LIMIT $thisPageResult,$resultPerPage ";
                                      if($run=mysqli_query($con,$sql)){
                                           ?>
                                        <table class="w3-table-all">
                                           <style type="text/css">
