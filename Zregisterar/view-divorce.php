                                 ...
                                 <!----------=========Search Begins here====================-->
                                  <div style="float: right;">
                                    <form action="" method="POST">
                                      <input type="text" name="divnum" placeholder="Divorce Number.." style="border-radius: 5%;border-color: blue;padding-left: 10px;">
                                  ...
                                  <?php
                                      ...
                                      <!--====================  <h1>Searched</h1>=================-->
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM divorceevent WHERE zcode='$ZCode' AND dveventnum='$divNumber' ";
                                         ...
                                         $sql="SELECT * FROM divorceevent WHERE zcode='$ZCode' AND dveventnum='$divNumber' order by id desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                              $check=mysqli_num_rows($run);
                                              if (!empty($divNumber) && $check==0) {
                                           ...
                                           while($row=mysqli_fetch_array($run)){
                                               ...
                                               <tr>
                                                 ...
                                                 <td><?php echo $row['wfnamedv']." ".$row['wmnamedv']." ".$row['wlnamedv']; ?> </td>
                                                  ...
                                                  <td><a href="report-divorce-individual.php?DivID=<?php echo $row['dveventnum']; ?>"><i class="fa fa-bullhorn"></i></a></td>
                                                </tr>
                                              <?php
                                               ?>       
                                              </a><?php
                                  ...
                                  <?php
                                      ...
                                      //  echo "Begin Search";
                                       ...
                                       <?php 
                                          ...
                                          $resultPerPage=10;
                                          $query="SELECT *FROM divorceevent WHERE zcode='$ZCode' ";
                                          $run=mysqli_query($con,$query);
                                          $num=mysqli_num_rows($run);
                                          $numberOfPages=ceil($num/$resultPerPage);
                                         ...
                                         $thisPageResult=($page-1)*$resultPerPage;
                                         $sql="SELECT * FROM divorceevent WHERE zcode='$ZCode' order by id desc LIMIT $thisPageResult,$resultPerPage ";
                                        if($run=mysqli_query($con,$sql)){
                                             ?>
                                          <table class="w3-table-all">
                                            <style type="text/css">
