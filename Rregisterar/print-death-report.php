   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo " "." ".'<b>'."GENERATE REPORT FOR DEATH EVENT ".'</b>';?> </h2></span>
                    </div>
                </div>
                                        ...
                                        <?php 
                                             ...
                                             if(isset($_GET['DeathID'])){
                                                   ...
                                                   $deathid=$_GET['DeathID'];
                                                    ...
                                                    $selectreport="SELECT * FROM report WHERE eventnumber ='$deathid' AND role='$role' AND type='Death' AND reportby='$LoggedInName' ORDER BY id DESC";
                                       ...
                                       <input type="text" name="reportTitle" readonly="" value="<?php echo $Title; ?>" style="border-top:none;border-bottom: 1px solid black;border-left: none; color: black;width: 400px;">
                                            ...
                                            <div class="col-md-11" style="color: black;">
                                              <?php
                                                  if(isset($_GET['DeathID'])){
                                                    ...
                                                    $deathid=$_GET['DeathID'];
                                                    $selectRep="SELECT * FROM report WHERE eventnumber ='$deathid' AND role='$role' AND type='Death' AND reportby='$LoggedInName' ORDER BY id DESC";
                                        ...
                                        <div class="col-md-12" style="color: black;margin-left: 50px;padding-right:100px; ">
                                            <?php
                                               ...
                                               echo "<br><br><br><br>";
                                               echo "<b><p style='margin-left:400px;'>$nameUp</p></b>";
