   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue; ">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo " "." ".'<b>'."ADOPTION ANNNUAL REPORT".'</b>';?> </h2></span>
                    </div>
                </div>
                <!--let begin here-->
                            ...
                            <div class="col-lg-12 clear-padding-xs">
                               ...
                               <div class="report" style="border:thick solid black;">                                  
                                    <?php
                                      ...
                                      <h4 class="w3-text-black" style="font-weight: bold;font:serif; text-align: center;">List Of Registered Adoption Event In <?php echo $year; ?></h4>
                                      <br>
                                      <div class="birhteport" style="margin-left: 10px; align-items: center;">
                                      	...
                                      	<?php
                                      		$selectAdoption="SELECT * FROM adoptevent WHERE  regyear='$year'";
                                      		$adoptResult=mysqli_query($con,$selectAdoption);

                                      		$check=mysqli_num_rows($adoptResult);
                                      				if ($check==0) {
                                      					echo "<script>alert('No Adoption In this year');</script>";
