   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue; ">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo " "." ".'<b>'."MARRIAGE ANNNUAL REPORT".'</b>';?> </h2></span>
                    </div>
                </div>
                <!--let begin here-->
                <div class="main-content" id="content-wrapper">
			              ...
			              <script type="text/javascript">
			                ...
			                <form style="margin-top: -30px;">
			                   <input type="button" name="" onclick="printDiv('print-content')" value="Print Report" style="float: right; margin-bottom: -10px; margin-right: 5px;" class="w3-button w3-green w3-btn-block w3-section w3-padding">
			                </form>
                <!--=====================Print Ends Here==============================-->
                            ...
                            <div class="col-lg-12 clear-padding-xs">
                               ...
                               <div class="report" style="border:thick solid black;">                                  
                                    <?php
                                      ...
                                      <h4 class="w3-text-black" style="font-weight: bold;font:serif; text-align: center;">List Of Registered Marriage Event in <?php echo "$year"; ?></h4>
                                      <br>
                                      <div class="birhteport" style="margin-left: 10px; align-items: center;color: black;">
                                      	...
                                      	<?php
                                      		$selectMarriage="SELECT * FROM marriagevent WHERE  regyear='$year'";
