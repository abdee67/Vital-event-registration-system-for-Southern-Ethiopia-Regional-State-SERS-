   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue;">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo " "." ".'<b>'."GENERATE REPORT FOR DIVORCE EVENT ".'</b>';?> </h2></span>
                    </div>
                </div>
                                    	...
                                    	<?php 
                                             ...
                                             if(isset($_GET['DivorceID'])){
                                                   ...
                                                   $divorceid=$_GET['DivorceID'];
                                                    ...
                                                    $selectreport="SELECT * FROM report WHERE eventnumber ='$divorceid' AND reportby='$LoggedInName' AND role='$role' AND type='Divorce' ORDER BY id DESC";
                                            ...
                                            <div class="col-md-11" style="color: black;width: 897px;border-top: none;">
                                              <?php
                                                  ...
                                                  if(isset($_GET['DivorceID'])){
                                                    ...
                                                    $divorceid=$_GET['DivorceID'];
                                                    $selectRep="SELECT * FROM report WHERE eventnumber='$divorceid'AND reportby='$LoggedInName' AND role='$role'AND type='Divorce' ORDER BY id DESC";
