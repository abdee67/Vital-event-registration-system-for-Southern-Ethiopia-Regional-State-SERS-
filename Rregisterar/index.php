   ...
   <body class="nav-md">
        ...
        <div class="w3-center" style="margin-top: 20px;">
            <span>
                <h6 class="w3-center item-title w3-round w3-animate-zoom" style="font-size: 50px; color: black; padding: 10px; font-weight: bold;">
                    <i class="w3-padding w3-animate-fading"><b>SOUTH EASTERN REGIONAL STATE PAGE</b></i>
                </h6>
            </span>                   
        </div>
    </div>
    ...
    <div class="main-content" id="content-wrapper">
        <div class="container-fluid">
            <?php
                // Retrieve user data to check if the first password change is required
                ...
                // If first login, prompt user to change password
                if ($FirstLogin == '0') {
                    echo "<script> 
            ...
            <!-- Fetch the number of registered records for various events -->
            <?php
                // Select birth events
