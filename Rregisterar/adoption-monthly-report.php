                               ...
                               <div class="report" style="border:thick solid black;">                                  
                                    <?php
                                      ...
                                      <div class="birhteport" style="margin-left: 10px; align-items: center;">
                                      	...
                                      	<?php
                                      		$selectAdoption="SELECT * FROM adoptevent WHERE regyear='$year' AND regmonth='$month' ";
                                      		$adoptResult=mysqli_query($con,$selectAdoption);

                                      		$check=mysqli_num_rows($adoptResult);
                                      				if ($check==0) {
                                      					echo "<script>alert('No Adoption Registered In Period You Provide Please Choose Valid Year or Month');</script>";
