   ...
   <body class="nav-md" >
    ...
    <div class="right_col" role="main">
                ...
                <div class="row tile_count " style="border-bottom: 3px solid cadetblue; ">
                    ...
                    <span ><h2 class="w3-center" style="font-size: 30px; color: black;"><?php echo " "." ".'<b>'."MONTHLY BIRTH REPORT ".'</b>';?> </h2></span>
                    </div>
                </div>
                <!--let begin here-->
                            ...
                            <div class="col-lg-12 clear-padding-xs">
                               ...
                               <div class="report" style="border:thick solid black;">                                  
                                    <?php
                                      ...
                                      <h4 class="w3-text-black" style="font-weight: bold;font:serif; text-align: center;">List Of Registered Birth Event In <?php echo "$month".",". "$year"; ?></h4>
                                      <br>
                                      <div class="birhteport" style="margin-left: 10px; align-items: center;">
                                      	...
                                      	<?php
                                      		$selectBirth="SELECT * FROM birthevent WHERE  regyear='$year' AND regmonth='$month'";
                                      		$birthResult=mysqli_query($con,$selectBirth);

                                      		$check=mysqli_num_rows($birthResult);
                                      				if ($check==0) {
                                      					echo "<script>alert('No Birth Registered In Period You Provide Please Choose Valid Year or Month');</script>";
